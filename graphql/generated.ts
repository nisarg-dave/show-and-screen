...
export type Mutation = {
  ...
  removeFromWantToWatchMovies: Movie;
  removeFromWantToWatchTvShows: TvShow;
};
...
export type MutationRemoveFromWantToWatchMoviesArgs = {
  movie: MovieIdInput;
  user: FindUserInput;
};


export type MutationRemoveFromWantToWatchTvShowsArgs = {
  tvShow: TvShowIdInput;
  user: FindUserInput;
};
...
export type RemoveFromToWatchMoviesMutationMutationVariables = Exact<{
  user: FindUserInput;
  movie: MovieIdInput;
}>;


export type RemoveFromToWatchMoviesMutationMutation = { __typename?: 'Mutation', removeFromWantToWatchMovies: { __typename?: 'Movie', id: string, title: string, posterPath: string, backdropPath: string } };

export type RemoveFromToWatchTvShowsMutationMutationVariables = Exact<{
  user: FindUserInput;
  tvShow: TvShowIdInput;
}>;


export type RemoveFromToWatchTvShowsMutationMutation = { __typename?: 'Mutation', removeFromWantToWatchTvShows: { __typename?: 'TvShow', id: string, title: string, posterPath: string } };
...
export const RemoveFromToWatchMoviesMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveFromToWatchMoviesMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FindUserInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"movie"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MovieIdInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeFromWantToWatchMovies"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"user"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user"}}},{"kind":"Argument","name":{"kind":"Name","value":"movie"},"value":{"kind":"Variable","name":{"kind":"Name","value":"movie"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"posterPath"}},{"kind":"Field","name":{"kind":"Name","value":"backdropPath"}}]}}]}}]} as unknown as DocumentNode<RemoveFromToWatchMoviesMutationMutation, RemoveFromToWatchMoviesMutationMutationVariables>;
export const RemoveFromToWatchTvShowsMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveFromToWatchTvShowsMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FindUserInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tvShow"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TvShowIdInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeFromWantToWatchTvShows"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"user"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user"}}},{"kind":"Argument","name":{"kind":"Name","value":"tvShow"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tvShow"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"posterPath"}}]}}]}}]} as unknown as DocumentNode<RemoveFromToWatchTvShowsMutationMutation, RemoveFromToWatchTvShowsMutationMutationVariables>;
